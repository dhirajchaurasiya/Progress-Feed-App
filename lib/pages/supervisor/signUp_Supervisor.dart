...
class SignUpSupervisor extends StatefulWidget {
  const SignUpSupervisor({super.key});

  @override
  State<SignUpSupervisor> createState() => _SignUpSupervisorState();
}

class _SignUpSupervisorState extends State<SignUpSupervisor> {
  @override
