...
class SignUpContractor extends StatefulWidget {
  const SignUpContractor({super.key});

  @override
  State<SignUpContractor> createState() => _SignUpContractorState();
}

class _SignUpContractorState extends State<SignUpContractor> {
  @override
                      ...
                      child: Column(
                        children: [
                          ...
                          ElevatedButton(
                            ...
                            onPressed: () {
                              Navigator.pushNamed(context, 'Navigations');
                            },
                            child: Text(
                              "Sign UP",
